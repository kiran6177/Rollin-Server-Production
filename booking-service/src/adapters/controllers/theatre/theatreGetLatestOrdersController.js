...
export class TheatreGetLatestOrders{
    constructor(dependencies){
        this.theatreGetLatestOrdersUseCase = new dependencies.UseCase.TheatreLatestOrdersGet(dependencies)
        this.awsConfig = new AwsConfig()
    }

    async getLatestOrders(req,res,next){
        try {
            const resultData = await this.theatreGetLatestOrdersUseCase.execute(req.query,req?.theatre);

...
export class TheatreGetSingleShow{
    constructor(dependencies){
        this.theatreGetSingleShowUseCase = new dependencies.UseCase.TheatreSingleShowGet(dependencies)
        this.awsConfig = new AwsConfig()
    }

    async getSingleShow(req,res,next){
        try {
            const resultData = await this.theatreGetSingleShowUseCase.execute(req.body);

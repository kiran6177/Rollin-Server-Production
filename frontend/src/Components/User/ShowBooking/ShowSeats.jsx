            ...
            <div className='sm:border-2 border-[#f6ae2d] rounded-sm bg-black px-4 sm:px-0'>
                ...
                <div className='sm:border-b-2 border-[#f6ae2d] py-6 px-5 sm:px-10 flex flex-col gap-4'> 
                    {showPay && <div className='flex justify-center my-5'>
                        <button onClick={handlePayment} className='bg-[#f6ae2d] border-2 border-[#f6ae2d] text-black px-4 py-2 rounded-sm w-[80%] md:w-[40%] font-medium tracking-widest hover:bg-black hover:text-white transition-all duration-150 ease-linear'>PAY Rs.{amount}</button>
                    </div>}

    ...
    <div className='min-h-[100vh] relative flex justify-center items-center pt-32 pb-12 h-auto login-bg'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col items-center  gap-6 border-2 border-[#F6AE2D] rounded-md bg-black backdrop-blur-sm w-[80%] md:w-[69%] lg:w-[62%] xl:w-[55%] 2xl:w-[45%] py-12'>
            ...
            <div className="w-[90%] md:w-[85%]">
                ...
                <input type="text" value={name} onChange={(e)=>setName(e.target.value)} className='w-[100%] my-2 p-2 border-2 rounded-md text-xs md:text-base bg-black text-white border-[#f6ae2d]'/>
            </div>
            <div className="w-[90%] md:w-[85%]">
                <label className='text-white text-xs tracking-widest'>Email</label>
                <input type="text" value={email} onChange={(e)=>setEmail(e.target.value)} className='w-[100%] my-2 p-2 border-2 rounded-md text-xs md:text-base bg-black text-white border-[#f6ae2d]'/>
            </div>
            ...
            <div className="w-[90%] flex flex-col sm:flex-row items-center justify-between md:w-[85%]">
                <div className='w-[100%] sm:w-[70%]'>
                    ...
                    <input type="text" value={location} onChange={(e)=>setLocation(e.target.value)} className='w-[100%] my-2 p-2 border-2 rounded-md text-xs md:text-base bg-black text-white border-[#f6ae2d]'/>
                </div>
            ...
            <div className="w-[90%] md:w-[85%]">
                ...
                <input type="text" value={street} onChange={(e)=>setStreet(e.target.value)} className='w-[100%] my-2 p-2 border-2 rounded-md text-xs md:text-base bg-black text-white border-[#f6ae2d]'/>
            </div>
            <div className="w-[90%] md:w-[85%]">
                <label className='text-white text-xs tracking-widest'>Landmark</label>
                <input type="text" value={landmark} onChange={(e)=>setLandmark(e.target.value)} className='w-[100%] my-2 p-2 border-2 rounded-md text-xs md:text-base bg-black text-white border-[#f6ae2d]'/>
            </div>
            <div className="w-[90%] md:w-[85%]">
                <label className='text-white text-xs tracking-widest'>City</label>
                <input type="text" value={city} onChange={(e)=>setCity(e.target.value)} className='w-[100%] my-2 p-2 border-2 rounded-md text-xs md:text-base bg-black text-white border-[#f6ae2d]'/>
            </div>
            <div className="w-[90%] md:w-[85%]">
                <label className='text-white text-xs tracking-widest'>State</label>
                <input type="text" value={state} onChange={(e)=>setState(e.target.value)} className='w-[100%] my-2 p-2 border-2 rounded-md text-xs md:text-base bg-black text-white border-[#f6ae2d]'/>
            </div>
            <div className="w-[90%] md:w-[85%]">
                <label className='text-white text-xs tracking-widest'>Pincode</label>
                <input type="number" value={pin} onChange={(e)=>setPin(e.target.value)} className='w-[100%] my-2 p-2 border-2 rounded-md text-xs md:text-base bg-black text-white border-[#f6ae2d]'/>
            </div>

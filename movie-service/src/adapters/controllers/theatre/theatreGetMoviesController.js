...
export class TheatreGetAllMovies{
    constructor(dependencies){
        this.theatreGetAllMoviesUseCase = new dependencies.UseCase.TheatreAllMoviesGet(dependencies)
        this.awsConfig = new AwsConfig()
    }

    async getAllMovies(req,res,next){
        try {
            const resultData = await this.theatreGetAllMoviesUseCase.execute(req.body);

...
export class TheatreEditTier{
    constructor(dependencies){
        this.theatreEditTierUseCase = new dependencies.UseCase.TheatreTierEdit(dependencies)
        this.awsConfig = new AwsConfig()
    }

    async editTier(req,res,next){
        try {
            const resultData = await this.theatreEditTierUseCase.execute(req.body);

...
export class TheatreAddScreen{
    constructor(dependencies){
        this.theatreAddScreenUseCase = new dependencies.UseCase.TheatreScreenAdd(dependencies)
        this.awsConfig = new AwsConfig()
    }

    async addScreen(req,res,next){
        try {
            const resultData = await this.theatreAddScreenUseCase.execute(req.body);
